...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        [responseLabel autoSetDimension:ALDimensionWidth toSize:80];
...
- (void)tap:(ImageViewTapGestureRecognizer *)recognizer
{
    ...
    HZShowImageView *showImageView = [[HZShowImageView alloc]initWithFrame:CGRectMake(0, 0, DEF_SCREEN_WIDTH, DEF_SCREEN_HEIGHT) withImageArray:@[PATH(_model.image)] clickIndex:index];
    [showImageView show];
}
